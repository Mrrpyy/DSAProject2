...
//build both structures from the same dataset
    HashTable hashTable;
...
//sample titles across the dataset
...
//include searches for missing titles
...
//repeat searches to reduce timer noise
    constexpr int rounds = 3;

//prevent the compiler from removing search calls
...
//time several autocomplete prefixes
